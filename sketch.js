...
function setup() {
  ...
  hex1 = new Box(845, 150, 50, 50);
  hex2 = new Box(895, 150, 50, 50);
  hex3 = new Box(945, 150, 50, 50);
  hex4 = new Box(870, 100, 50, 50);
  hex5 = new Box(920, 100, 50, 50);
  hex6 = new Box(895, 50, 50, 50);
